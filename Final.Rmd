...
```{r fig3, echo=FALSE, fig.align="center", fig.width=4,fig.height=4.5,fig.cap="\\label{fig:fig3}Word Frequency,"}
...
```{r fig4, echo=FALSE, fig.align="center", fig.width=3.5,fig.height=3,fig.cap="\\label{fig:fig4}Sentiment scores of Elon's tweets"}
...
```{r fig7, echo=FALSE, fig.width=3.5,fig.height=3,fig.cap="\\label{fig:fig7}density of polarity scores"}
...
```{r fig8, echo=FALSE, fig.width=3.5,fig.height=3,fig.cap="\\label{fig:fig8}plot of Emotions"}
...
```{r fig12, echo=FALSE, fig.width=3.5,fig.height=3,fig.cap="\\label{fig:fig12}Polarity Density of Elon's tweets resampled"}
...
```{r fig13, echo=FALSE, fig.width=3.5,fig.height=3,fig.cap="\\label{fig:fig13}Emotion's Plot of Elon's tweets resampled"}
