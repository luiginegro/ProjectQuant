...
```{r fig25, echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:fig25}Elon Musk's Tweets on Dogecoin and LogDoge's Changing Points Dates"}
...
labs(x = "timestamp",
         ...
         color = "Legend") + scale_color_manual(values = colorsD) +
geom_line() + 
geom_point(data = prova, aes(color ="tweets"), size = 3)
```
