...
library(ggplot2)
library(dplyr)
colors <- c("tweets" = "deeppink",  "breaking points" = "blue")
btc_hist[2750:3200,] %>%
ggplot(aes(x = timestamp, y = open)) +
geom_line() + 
...
library(crypto2)
=======
Do the same with Doge

```{r, echo=FALSE, results=FALSE}
>>>>>>> fb0b3084ea2a8a542893d8333262c76cc563e1e0
