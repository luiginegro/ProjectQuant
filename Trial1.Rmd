...
The first data mining activities were conducted around 2013 with the scope of highlighting how Twitter played a central role in spreading awareness after a natural disaster occured.[cit]. Further steps involved using Twitter's data to predict the happening of those same phenomena []; weakly supervised and Online learning of word models for classification to detect disaster reporting tweets[2018]. Similar analyses have been performed to forecast political election's results [[]]] and are now being applied to the cryptocurrency and stock markets.
