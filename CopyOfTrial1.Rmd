...
date: "04/04/2022"
bibliography: ./referencesProject_com.bib
...
```{r fig2, echo=FALSE, fig.width=3.5,fig.height=3,fig.cap="\\label{fig:fig2}Crypto-related content interaction"}
#plotting 
...
```{r fig3, echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:fig3}BTC price compared with crypto-related tweets' date", include=FALSE}
btc_hist %>%
...
```{r fig4, echo=FALSE, fig.width=4,fig.height=4.5,fig.cap="\\label{fig:fig4}Word Frequency,"}
...
```{r fig5, echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:fig5}Wordcloud of most commons words", include=FALSE}
